...
public extension Array {
    ...
    */
    public func maxBy <U: Comparable> (_ call: @noescape (Element) -> (U)) -> Element? {
    ...
    */
    public func minBy <U: Comparable> (_ call: @noescape (Element) -> (U)) -> Element? {
    ...
    */
    public func each (_ call: @noescape (Element) -> ()) {
    ...
    /**
        ...
        - parameter call: Function to call for each element
    */
    public func each (_ call: @noescape (Int, Element) -> ()) {
    ...
    /**
        ...
        - parameter call: Function to call for each element
    */
    @available(*, unavailable, message: "use 'reverse().each' instead") public func eachRight (_ call: @noescape (Element) -> ()) {
        reversed().each(call)
    }
    ...
    /**
        ...
        - parameter call: Function to call for each element
    */
    @available(*, unavailable, message: "use 'reverse().each' instead") public func eachRight (_ call: @noescape (Int, Element) -> ()) {
    ...
    */
    public func all (_ test: @noescape (Element) -> Bool) -> Bool {
        for item in self {
            if !test(item) {
                return false
            }
    ...
    */
    public func takeWhile (_ condition: @noescape (Element) -> Bool) -> Array {
