...
public extension String {
    ...
    */
    subscript (range: Range<Int>) -> String? {
        ...
        let range = (characters.index(start Index, offsetBy: range.lowerBound) ..< characters.index(startIndex, offsetBy: range.upperBound))
    ...
    */
    func toDate(_ format : String? = "yyyy-MM-dd") -> Date? {
        ...
        dateFmt.timeZone = NSTimeZone.current
        if let fmt = format {
